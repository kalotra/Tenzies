...
import { a as require_browser_external_node_process, i as require_browser_external_node_tty } from "./vite.js";
//#region node_modules/rolldown/dist/shared/prompt-B1Yc1NPt.mjs
...
var iD = sD(), v = /* @__PURE__ */ new Set(["\x1B", ""]), CD = 39, w$1 = "\x07", W$1 = "[", rD = "]", R = "m", y = `${rD}8;;`, V$1 = (t) => `${v.values().next().value}${W$1}${t}${R}`, z = (t) => `${v.values().next().value}${y}${t}${w$1}`, ED = (t) => t.split(" ").map((u) => A$1(u)), _ = (t, u, F) => {
	const e = [...u];
